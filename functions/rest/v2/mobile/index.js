...
export async function onRequest(context) {
    ...
    const basePath = url.pathname.replace(/\/$/, "") || "/rest/v2/mobile";

    const payload = {
        status: "info",
        message: "Please select a resource in mobile.",
        help: {
            availableResources: ["custom", "memorable", "purchase"],
            example: `${basePath}/memorable`,
